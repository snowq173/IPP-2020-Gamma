 ...
 * ruchu i jest przynajmniej jedno pole, na które gracz @p player może wykonać
 * złoty ruch (pole zajęte przez innego gracza takie, że po zajęciu go przez gracza
 * @p player ani gracz wykonujący złoty ruch, ani gracz, do którego należało
 * to pole będzie posiadał nie więcej obszarów niż maksymalna liczba
 * ustalona w strukturze gry)
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry,
 * @param[in] player  – numer gracza, liczba dodatnia niewiększa od wartości
 *                      @p players z funkcji @ref gamma_new.
 * @return Wartość @p true, jeśli gracz jeszcze nie wykonał w tej rozgrywce
 * złotego ruchu i istnieje pole, na które gracz może wykonać złoty ruch,
 ...
 * @param[in] g - wskaźnik na strukturę przechowującą stan gry.
 * @return Liczba całkowita będąca szerokością planszy ustaloną
 * w strukturze gry.
 */
 ...
 * @param[in] g - wskaźnik na strukturę przechowującą stan gry.
 * @return Liczba całkowita będąca wysokością planszy ustaloną
 * w strukturze gry.
 */
 ...
 * @param[in] g - wskaźnik na strukturę przechowującą stan gry
 * @return Liczba całkowita będąca liczbą graczy przechowywaną
 * w strukturze gry.
 */
